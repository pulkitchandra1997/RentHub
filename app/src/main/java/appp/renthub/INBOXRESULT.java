...
public class INBOXRESULT implements Serializable{
    ...
    public INBOXRESULT(String msgid, String sendermail, String receivermail, String msg,  String dateofmsg, String timeofmsg,String sendername,  String senderpic,String receivername, String receiverpic) {
        this.msgid = msgid;
        this.sendermail = sendermail;
        this.receivermail = receivermail;
        this.sendername = sendername;
